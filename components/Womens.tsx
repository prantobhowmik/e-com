...
export default function Womens(){
    ...
    return(
        <div className="flex items-center px-16 space-x-5 ">
            <div className="flex flex-col ">
                <h1 className="text-[48px] text-end font-semibold">WOMEN COLLECTION</h1>
                <button
            ...
            <div className="">
                <Image src={'/women.png'} alt={'womens'} width={621} height={566} className=""/>
            </div>
        </div>
    )
}